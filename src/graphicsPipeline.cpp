...
void Engine::GraphicsPipeline::createGraphicsPipeline()
{
...
std::vector<char> Engine::GraphicsPipeline::readFile(const std::string& filename) 
{
...
VkShaderModule Engine::GraphicsPipeline::createShaderModule(const std::vector<char>& code) 
{
...
void Engine::GraphicsPipeline::createRenderPass()
{
