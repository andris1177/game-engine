...
Engine::Device::Device(VkInstance* i, VkSurfaceKHR* s, GLFWwindow* w)
    : instance(i), surface(s), window(w)
{
}
...
void Engine::Device::createSwapChain() 
{
...
VkSurfaceFormatKHR Engine::Device::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) 
{
...
VkPresentModeKHR Engine::Device::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) 
{
...
VkExtent2D Engine::Device::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) 
{
...
void Engine::Device::createImageViews()
{
